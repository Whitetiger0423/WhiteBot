...
vim 에디터 사용법은 [아래](#E3-VIM-에디터-사용법)서 다루겠습니다.
...
푸시 또한 한 브랜치에서 언제나 가능합니다.  
여러 커밋을 한 번에 푸시하셔도 되고, 커밋할 때마다 바로바로 푸시하셔도 됩니다.
...
머지나 리베이스 작업을 할 때, 스테이징된 내용이 있으면 안 되는데, 이때 `stash`을 사용합니다.  
