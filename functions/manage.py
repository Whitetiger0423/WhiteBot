...
class manage(commands.Cog):
    ...
    async def server(self, ctx):
        ...
        embed.add_field(name='서버 이름: ', value=f'{self.guild.name}', inline = False)
        embed.add_field(name='서버 ID: ', value=f'`{self.guild.id}`', inline = False)
        embed.add_field(name='서버 지역: ', value=f'{self.guild.region}', inline = False)
        embed.add_field(name='서버 부스트 레벨: ', value=f'{self.guild.premium_tier}레벨', inline = False)
        embed.add_field(name='멤버 수: ', value=f'{self.guild.member_count}', inline = False)
        await ctx.respond(embed=embed)
    ...
    async def user(self, ctx):
        ...
        embed.add_field(name='계정명: ', value=f'{self.author.name}', inline = False)
        embed.add_field(name='ID: ', value=f'`{self.author.id}`', inline = False)
        embed.add_field(name='이 서버에서의 별명: ', value=f'{self.author.display_name}', inline = False)
        embed.add_field(name='멘션: ', value=f'{self.author.mention}', inline = False)
        await ctx.respond(embed=embed)
